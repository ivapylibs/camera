...
imagery after alignment.  Example code obtained from 
[github issue](https://github.com/IntelRealSense/librealsense/issues/4306)
for RealSense library from Intel.  Shows short example with alignment
included.
'''
#=============================== bag04align ==============================
